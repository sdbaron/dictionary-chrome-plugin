    ...
    return (<div className="sdb-popup-card-def-sound __sdb-popup-card-def-sound_animation__" onClick={ this.handlePlayClick.bind(this) }>
      <svg className="" data-reactid="s0.0.0" viewBox="0 0 25 21">
        ...
        <g fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
          <path
            d="M5.525 7.445h-3.5c-.83 0-1.5.672-1.5 1.5v3c0 .828.67 1.5 1.5 1.5h3.5l7 7v-20l-7 7zM15.525 6.945c1.125.818 2 2.002 2 3.5 0 1.498-.874 2.682-2 3.5"
            stroke="#1D9BF5"></path>
      ...
      <svg className="" data-reactid="s0.0.1" viewBox="0 0 25 21">
        <title> sound4 </title>
        <g fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
          <path d="M5.525 7.445h-3.5c-.83 0-1.5.672-1.5 1.5v3c0 .828.67 1.5 1.5 1.5h3.5l7 7v-20l-7 7z"
                stroke="#1D9BF5"></path>
